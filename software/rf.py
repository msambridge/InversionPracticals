...
#import sys
#try:
#    from . import rfc as rfm # if file is only to be used as library
#except:
...
try:
    ...
    import os
    basedir = os.path.split(os.path.abspath(__file__))[0] # Directory of this current file
    sys.path.append(basedir)
    sys.path.append(basedir+'/rfc')
    import rfc as rfm 
